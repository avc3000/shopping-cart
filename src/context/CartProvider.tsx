...
const useCartContext = (initCartState: CartStateType) => {
  ...
  const totalPrice = new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(state.cart.reduce((previousValue, cartItem) => { return previousValue + (cartItem.qty * cartItem.price)}, 0));
...
const initCartContextState: UseCartContextType = {
  dispatch: () => { console.log('initCartContext'); },
